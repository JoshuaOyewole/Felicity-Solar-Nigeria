...
function index() {
    ...
    return (
        <main className='font-inter  overflow-y-hidden'>
            ...
            <AdUnit adSlot="8449504765" adFormat="auto" fullWidthResponsive />
            {/* 
// Between content sections
        <AdUnit adSlot="8449504765" adFormat="auto" fullWidthResponsive />

        // Sidebar rectangle
        <AdUnit adSlot="8449504765" adFormat="rectangle" className="my-4" />

        // In-feed / native
        <AdUnit adSlot="8449504765" adFormat="fluid" />
 */}
        </main>
    )
}
